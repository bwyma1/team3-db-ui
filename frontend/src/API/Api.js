...
export const addTruck = async (email, model, make, year, mileage, max_miles, long_discount_days, long_discount_percent, long_discount_flat,truck_image, is_available, truck_capacity, cargo_capacity, price) => {
